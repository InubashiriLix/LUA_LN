...
-- end
-- THEY DIED
-- DONT LOOK BACK IN HATE

Shape = require("src.inherit_shape")
Rectangle = require("src.inherit_rectangle")

local shape = Shape:new(12, 12)
local rectangle = Rectangle:new(shape, 43, 31)

shape:Info()
rectangle:Info()

local ReloadRectangleTest = Rectangle:new(11, 11)
ReloadRectangleTest:Info()
